...
import {
  require_warning
} from "./chunk-P2KTZGNW.js";
=======
  useUncontrolledProp,
  useWillUnmount
} from "./chunk-H6LTTN44.js";
import {
  require_jsx_runtime
...
<<<<<<< HEAD
  EXITING
} from "./chunk-SVLDY5FV.js";
import "./chunk-UZ56RCUI.js";
import {
  require_classnames,
  require_prop_types
} from "./chunk-URYE4SIV.js";
import {
  require_react_dom
...
var AbstractModalHeader = React68.forwardRef(({
  ...
  const context4 = (0, import_react24.useContext)(ModalContext_default);
...
var Modal2 = React71.forwardRef(({
  ...
  const renderBackdrop = (0, import_react25.useCallback)((backdropProps) => (0, import_jsx_runtime73.jsx)("div", {
    ...backdropProps,
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react29.useState)(() => mql ? mql.matches : false);
  useIsomorphicEffect_default(() => {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react30.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
var Offcanvas = React82.forwardRef(({
  ...
  const renderBackdrop = (0, import_react31.useCallback)((backdropProps) => (0, import_jsx_runtime84.jsx)("div", {
    ...backdropProps,
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime101.jsxs)(import_jsx_runtime100.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react38.cloneElement)(children, triggerProps), (0, import_jsx_runtime99.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
function useTabPanel(_ref) {
  ...
  const context4 = (0, import_react40.useContext)(TabContext_default);
  if (!context4)
...
var ToastHeader = React114.forwardRef(({
  ...
  const context4 = (0, import_react42.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
